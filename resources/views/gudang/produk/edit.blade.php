        ...
        <form action="{{ route('produk.update', $data->id) }}" method="post">
            ...
            <x-card title="Edit Produk">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"><x-input name="stok" label="Stok" type="number" :value="$stok" /></div>
                    <div class="col-md-2"><x-input name="limit_stok" label="Limit Stok" type="number" :value="$data->limit_stok" /></div>
                </div>
                <div class="row">
